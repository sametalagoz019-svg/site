  ...
  return (
    <header className="site-header sticky">
      <div className="masthead-strip masthead-strip-top">
        <div className="container masthead-strip-inner">
          ...
          <div className="masthead-utility">
            <Link href="/son-dakika" target="_blank" rel="noopener noreferrer">
              Güncel Akış
            </Link>
      ...
      <div className="site-header-body container site-header-body-portal">
        <Link href="/" className="brand brand-portal" target="_blank" rel="noopener noreferrer">
        ...
        <nav className="primary-nav primary-nav-portal">
          {PUBLIC_CATEGORIES.map((category) => (
            <Link key={category} href={`/category/${slugify(category)}`} target="_blank" rel="noopener noreferrer">
              {category}
            </Link>
          ))}
        </nav>
        ...
        <div className="header-actions header-actions-portal">
          <Link href="/son-dakika" className="header-cta" target="_blank" rel="noopener noreferrer">
            Son Dakika
          </Link>
        </div>
      </div>
