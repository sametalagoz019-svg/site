...
function PreviewList({ title, items, slotLabel }) {
  return (
...
function HomepagePreview({ settings, publishedNews }) {
  ...
  const moduleSummaries = {
    editorialBand: <PreviewList title="Sürmanşet" slotLabel="Sürmanşet Kategorisi" items={preview.surmanset} />,
    mediaSponsor: (
      <section className="homepage-preview-card">
        <div className="homepage-preview-headline">
    ...
    categoryLanes: <PreviewList title="Öne Çıkan" slotLabel="Öne Çıkan Kategorisi" items={preview.featuredList} />,
    ...
    <section className="panel homepage-preview-panel">
      ...
      <div className="homepage-preview-frame">
        ...
        <div className="homepage-preview-split">
          <PreviewList title="Manşet" slotLabel="Manşet Kategorisi" items={preview.heroItems} />
          <PreviewList title="Öne Çıkan" slotLabel="Öne Çıkan Kategorisi" items={preview.featuredList} />
          <PreviewList title="Sürmanşet" slotLabel="Sürmanşet Kategorisi" items={preview.surmanset} />
